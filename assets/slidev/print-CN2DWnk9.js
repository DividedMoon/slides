import{d as _,$ as u,y as h,b as a,e as t,x as s,H as c,F as f,Z as v,o as n,a0 as g,l as x,g as b}from"../modules/vue-BLmQdX0u.js";import{u as y,d as N,_ as k}from"../index-MJCQesGk.js";import{a as p}from"../monaco/bundled-types-DAhpXgAL.js";import{N as T}from"./NoteDisplay-BbmgzOjj.js";import"../modules/shiki-vbwtq7uO.js";import"../modules/file-saver-DY7lxZlc.js";const w={id:"page-root"},D={class:"m-4"},H={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},B={class:"text-lg"},C={class:"font-bold flex gap-2"},P={class:"opacity-50"},S=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-main mb-8"},M=_({__name:"print",setup($){const{slides:m,total:d}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
